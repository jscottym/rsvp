...
function hasAnyEvents(day: CalendarDay) {
  ...
  return (
    indicators.in > 0 ||
    indicators.maybe > 0 ||
    indicators.waitlist > 0 ||
    indicators.organizing > 0
  );
}
</script>
...
<template>
  <div class="relative">
    ...
    <div class="relative -mx-4">
      <!-- Fade edges -->
      <div
        class="absolute left-0 top-0 bottom-0 w-4 bg-gradient-to-r from-gray-50 dark:from-gray-950 to-transparent z-10 pointer-events-none"
      ></div>
      <div
        class="absolute right-0 top-0 bottom-0 w-4 bg-gradient-to-l from-gray-50 dark:from-gray-950 to-transparent z-10 pointer-events-none"
      ></div>

      <!-- Scrollable days -->
      <div
        class="flex gap-1 overflow-x-auto px-4 pb-2 scrollbar-hide snap-x snap-mandatory"
      >
        <button
        ...
        >
          ...
          <div
            v-if="hasAnyEvents(day) && !(day.isFirstOfMonth && index < 21)"
          ...
          <div
            v-else-if="!(day.isFirstOfMonth && index < 21)"
            class="h-2 mt-0.5"
          ></div>
        </button>
      </div>
